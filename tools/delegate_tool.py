...
def _build_child_system_prompt(
    ...
    *,
    ...
    parts.append(
        ...
        "IF your inherited operating instructions (SOUL/profile above) "
        "define a closeout contract of their own — e.g. an Agent Operating "
        "Framework closeout with named sections such as Run Metrics, "
        "Policy Compliance and Discovery Promotions — follow THAT contract "
        "for this closeout, scaled to the size of the task; the generic "
        "structure below is the fallback when no such contract is "
        "inherited:\n"
