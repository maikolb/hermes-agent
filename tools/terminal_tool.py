...
#
# Windows must install the process-wide zero-UI boundary before importing the
# local backend.  LocalEnvironment is the real shell-spawn boundary; importing
# it first can retain an unbrokered subprocess reference and let Git Bash open
# Windows Terminal.  Fail closed rather than trade desktop focus for a command.
