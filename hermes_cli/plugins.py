...
VALID_HOOKS: Set[str] = {
    ...
    # Canonical Topic binding is committed; profile plugins may finish repo
    # onboarding for either a human-created Topic or project_topic_create.
    "on_project_provisioned",
