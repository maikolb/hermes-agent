...
def dispatcher_worker_protocol() -> str:
    ...
    return (
        ...
        "exists (code, commits, docs, and this card's own comments/history)."
        " Report a duplicate instead of rebuilding it.\n"
        ...
        "skipped or failed.\n"
        "4. CLOSEOUT — REQUIRED: finish by calling kanban_complete with "
