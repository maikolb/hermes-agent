...
The engineering skills use five canonical triage roles. This repository uses the default label strings.
...
When a skill names a role, use the corresponding tracker label from this table.
